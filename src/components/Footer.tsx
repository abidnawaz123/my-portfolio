...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-100/80 border-t border-slate-200 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        >
          ...
          {/* Quick Links */}
          <motion.div variants={itemVariants}>
            <h4 className="text-base font-bold text-slate-900 mb-3">Quick Links</h4>
          ...
          {/* Social Links */}
          <motion.div variants={itemVariants}>
            <h4 className="text-base font-bold text-slate-900 mb-3">Follow</h4>
